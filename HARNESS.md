...
Current release identity lives in `pyproject.toml` and `.harness/manifest.json`. For the dense maintainer identity and “what not to add casually” rules, read `docs/AWOKI_IDENTITY.md`; do not inject that dense file wholesale into normal user tasks.
